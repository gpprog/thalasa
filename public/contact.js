  ...
  copy.innerHTML = "© "+" "+theYear+" copyright :";




if (window.matchMedia("(max-width:1200px)").matches) {
    place_name = document.getElementsByTagName('input')[0].removeAttribute('placeholder');
    place_name = document.getElementsByTagName('input')[1].removeAttribute('placeholder');
    place_name = document.getElementsByTagName('input')[2].removeAttribute('placeholder');
